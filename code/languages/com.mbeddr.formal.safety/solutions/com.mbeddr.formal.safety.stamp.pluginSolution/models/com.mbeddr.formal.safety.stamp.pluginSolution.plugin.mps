...
<model ref="r:b7b6bd74-059d-44f8-a914-742bcb784075(com.mbeddr.formal.safety.stamp.pluginSolution.plugin)">
  ...
  <imports>
    ...
    <import index="3876" ref="r:41da1de9-e0ac-4004-abf8-e7ca69360a65(com.mbeddr.formal.safety.stamp.editor)" />
  </imports>
  <registry>
  ...
  <node concept="33ghlw" id="3onExzPnGul">
    ...
    <property role="TrG5h" value="ControlStructureNotationSwitcher" />
    <property role="33gmoF" value="true" />
    <property role="1QNlnu" value="Control Structure Diagrammatic View" />
    <ref role="2hhq6$" to="bewr:3HVC1H6VUjH" resolve="FunctionalControlStructure" />
    <node concept="33gmoH" id="3onExzPnGum" role="2hfSGL">
      <property role="33g7Lv" value="Control Structure Textual View" />
      <ref role="33glcW" to="3876:4bL3rTRDw$i" resolve="CONTROL_STRUCTURE_HINTS" />
      <ref role="33glcY" to="3876:4bL3rTRDw$j" resolve="TEXTUAL" />
    </node>
