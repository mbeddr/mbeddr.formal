...
<model ref="r:86e1d30e-c525-4e4a-b04c-847b5e4da62e(com.fasten.safety.bayesian_network.pluginSolution.plugin)">
  ...
  <node concept="33ghlw" id="3onExzPnGul">
    ...
    <property role="TrG5h" value="BayesianNetworkNotationSwitcher" />
    <property role="33gmoF" value="true" />
    <property role="1QNlnu" value="Diagrammatic View" />
    <ref role="2hhq6$" to="zqec:3sgpJkb4cfD" resolve="BayesianNetwork" />
    <node concept="33gmoH" id="3onExzPnGum" role="2hfSGL">
      <property role="33g7Lv" value="Textual View" />
      <ref role="33glcW" to="kfjy:3sgpJkb5jGh" resolve="BAYESIAN_NETWORK_HINTS" />
      <ref role="33glcY" to="kfjy:3sgpJkb5jGi" resolve="TEXTUAL" />
    </node>
