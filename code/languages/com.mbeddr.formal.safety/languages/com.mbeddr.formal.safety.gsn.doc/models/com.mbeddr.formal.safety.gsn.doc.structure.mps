...
<model ref="r:b5f49a49-cb87-432f-9c94-6a91c1e055e1(com.mbeddr.formal.safety.gsn.doc.structure)">
  ...
  <node concept="1TIwiD" id="5Ac1Q93INpM">
    ...
    <node concept="PrWs8" id="6FJpOMBsE3j" role="PzmwI">
  ...
  <node concept="1TIwiD" id="4pL_qfpQH1o">
    <property role="EcuMT" value="5076002785990463576" />
    ...
    <node concept="PrWs8" id="4pL_qfpQHNC" role="PzmwI">
      <ref role="PrY4T" to="87nw:2dWzqxEBBFG" resolve="IWord" />
    </node>
  </node>
</model>
