...
<model ref="r:a06544ed-39eb-44c0-b516-bb222deb41dc(com.fasten.safety.hiphops.structure)">
  ...
  <node concept="1TIwiD" id="4TCu33h0$RK">
    <property role="EcuMT" value="5649897883596639728" />
    <property role="TrG5h" value="OrHipHOPSExpression" />
    ...
    <node concept="PrWs8" id="4TCu33h0Yr0" role="PzmwI">
      <ref role="PrY4T" node="4TCu33h0$RL" resolve="IHIPHOPSLogicalExpression" />
    </node>
  </node>
  <node concept="PlHQZ" id="4TCu33h0$RL">
    <property role="EcuMT" value="5649897883596639729" />
    <property role="3GE5qa" value="exp" />
    <property role="TrG5h" value="IHIPHOPSLogicalExpression" />
  </node>
  <node concept="1TIwiD" id="4TCu33h0_Om">
    <property role="EcuMT" value="5649897883596643606" />
    <property role="TrG5h" value="AndHipHOPSExpression" />
    <property role="3GE5qa" value="exp" />
    <property role="34LRSv" value="&amp;" />
    <property role="R4oN_" value="and expression" />
    <ref role="1TJDcQ" to="ehqg:7mSH3Wnte8z" resolve="OrExpressionBase" />
    <node concept="PrWs8" id="4TCu33h0Yr2" role="PzmwI">
      <ref role="PrY4T" node="4TCu33h0$RL" resolve="IHIPHOPSLogicalExpression" />
    </node>
  </node>
</model>
