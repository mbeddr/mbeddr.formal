...
<model ref="r:ab00bc1f-8fc9-4bdf-9a87-1e2713aafade(com.fasten.req.odd.structure)">
  ...
  <node concept="1TIwiD" id="3Jn$RV31nMq">
    ...
    <node concept="1irR5M" id="6VJDb1ZHHOZ" role="rwd14">
      ...
      <node concept="1irPie" id="2nacnue1G$e" role="2rmM5M">
        <property role="1irPi9" value="⊛" />
        <node concept="3PKj8D" id="2nacnue1G$f" role="3PKjny">
          <property role="3PKj8l" value="228B22" />
        </node>
      </node>
      <node concept="1irR9n" id="2nacnue1G$g" role="2rmM5M">
        <node concept="3PKj8D" id="2nacnue1G$h" role="3PKjn_">
          <property role="3PKj8l" value="FFFFFF" />
        </node>
        <node concept="3PKj8D" id="2nacnue1G$i" role="3PKjnB">
          <property role="3PKj8l" value="FF8000" />
        </node>
      </node>
    </node>
