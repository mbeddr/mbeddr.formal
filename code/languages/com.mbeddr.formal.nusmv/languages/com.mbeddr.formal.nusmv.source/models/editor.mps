...
<model ref="r:60435497-3924-490b-802f-437244d70014(com.mbeddr.formal.nusmv.source.editor)">
  ...
  <node concept="24kQdi" id="6glUKoNLIo7">
    ...
    <node concept="3EZMnI" id="6glUKoNPfWh" role="2wV5jI">
      ...
      <node concept="3EZMnI" id="6glUKoNPfWJ" role="3EZMnx">
        <node concept="VPM3Z" id="6glUKoNPfWL" role="3F10Kt">
          <property role="VOm3f" value="false" />
        </node>
        <node concept="3F0ifn" id="6glUKoNPfWN" role="3EZMnx">
          <property role="3F0ifm" value="source name:" />
        </node>
        <node concept="3F0A7n" id="6glUKoNPfXf" role="3EZMnx">
          <ref role="1NtTu8" to="tpck:h0TrG11" resolve="name" />
        </node>
        <node concept="l2Vlx" id="6glUKoNPfWO" role="2iSdaV" />
      </node>
