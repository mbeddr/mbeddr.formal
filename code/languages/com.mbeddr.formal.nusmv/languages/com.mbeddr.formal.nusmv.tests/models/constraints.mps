...
<model ref="r:40dd7f9e-da21-4bbd-8578-a6f8beb050e0(com.mbeddr.formal.nusmv.tests.constraints)">
    ...
    <node concept="9S07l" id="7ODrlMnL7Ft" role="9Vyp8">
      <node concept="3clFbS" id="7ODrlMnL7Fu" role="2VODD2">
        <node concept="3clFbF" id="7ODrlMnLJRA" role="3cqZAp">
          <node concept="2OqwBi" id="7ODrlMnLKYN" role="3clFbG">
            <node concept="2OqwBi" id="7ODrlMnLKap" role="2Oq$k0">
              <node concept="nLn13" id="7ODrlMnLJRz" role="2Oq$k0" />
              <node concept="2Xjw5R" id="7ODrlMnLKuK" role="2OqNvi">
                <node concept="1xMEDy" id="7ODrlMnLKuM" role="1xVPHs">
                  <node concept="chp4Y" id="7ODrlMnLKFk" role="ri$Ld">
                    <ref role="cht4Q" to="fnq2:43FRfGJUFO5" resolve="TestStep" />
                  </node>
                </node>
                <node concept="1xIGOp" id="7ODrlMnLLN4" role="1xVPHs" />
              </node>
            </node>
            <node concept="3x8VRR" id="7ODrlMnLLmx" role="2OqNvi" />
          </node>
        </node>
      </node>
    </node>
  ...
  <node concept="1M2fIO" id="7ODrlMnLTjh">
    ...
    <node concept="9SQb8" id="7ODrlMnLTji" role="9SGkC">
      <node concept="3clFbS" id="7ODrlMnLTjj" role="2VODD2">
        <node concept="3SKdUt" id="7ODrlMnLXzK" role="3cqZAp">
          <node concept="3SKdUq" id="7ODrlMnLXzM" role="3SKWNk">
            <property role="3SKdUp" value="do not allow expressions in the test-steps" />
          </node>
        </node>
        <node concept="3clFbF" id="7ODrlMnLWdc" role="3cqZAp">
          <node concept="3fqX7Q" id="7ODrlMnLXg9" role="3clFbG">
            <node concept="2OqwBi" id="7ODrlMnLXgb" role="3fr31v">
              <node concept="2DD5aU" id="7ODrlMnLXgc" role="2Oq$k0" />
              <node concept="2Zo12i" id="7ODrlMnLXgd" role="2OqNvi">
                <node concept="chp4Y" id="7ODrlMnLXge" role="2Zo12j">
