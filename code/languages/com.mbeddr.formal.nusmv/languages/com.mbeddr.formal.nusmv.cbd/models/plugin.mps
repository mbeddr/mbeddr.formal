...
<model ref="r:eafddcbf-9c74-441b-9248-33b83f04924c(com.mbeddr.formal.nusmv.cbd.plugin)">
  ...
  <node concept="1lYeZD" id="6lrp79e9HCX">
    <property role="TrG5h" value="CBDSimulatorStepPerformerProvider" />
    <ref role="1lYe$Y" to="4agl:6lrp79e8eP0" resolve="SimulatorStepPerformerProvider" />
    ...
    <node concept="q3mfD" id="6lrp79e9HD3" role="jymVt">
      ...
      <node concept="3clFbS" id="6lrp79e9HD7" role="3clF47">
        <node concept="3clFbF" id="1EKbsQRao7T" role="3cqZAp">
          <node concept="10M0yZ" id="1EKbsQRaonW" role="3clFbG">
            <ref role="3cqZAo" to="9gw6:3fsZMFLIy84" resolve="INSTANCE" />
            <ref role="1PxDUh" to="9gw6:1EKbsQRa7_e" resolve="CBDSimulationStepPerformer" />
          </node>
        </node>
      </node>
